...
(4) and parse_E toks = 
(5)   let (toks,tree1) = parse_E toks in //1. error parse_E -> parse_M
...
For Reinforcement:
1. Study for exam to get good grade
2. Workout to stay healthy
3. 

Avoid Punishment:
1. Turning homework late and get reduced grade

Despite Punishment:
1. Playing badminton although the shuttlecock is so expensive
2. 
